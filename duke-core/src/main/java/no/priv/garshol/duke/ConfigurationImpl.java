...
public class ConfigurationImpl implements Configuration {
  ...
  // there are two modes: deduplication and record linkage. in
    ...
    /**
     * The probability threshold used to decide whether two records represent
     * the same entity. If the probability is higher than this value, the two
     * records are considered to represent the same entity.
     */
     ...
     * represent the same entity. If the probability is higher than this value,
     * the two records are considered possible matches. Can be 0, in which case
     * no records are considered possible matches.
     */
