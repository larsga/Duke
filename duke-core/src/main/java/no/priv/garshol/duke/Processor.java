...
public class Processor {
    ...
    /**
     * Does record linkage across the two groups, but does not link records
     * within each group.
     */
    public void link() {
    ...
    /**
     * Does record linkage across the two groups, but does not link records
     * within each group. With this method, <em>all</em> matches above threshold
     * are passed on.
     */
     ...
     * With this method, <em>all</em> matches above threshold are passed on.
     *
     * @since 0.4
     */
